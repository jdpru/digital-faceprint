...
Ultimately, this study aims to contribute to the establishment of an ontology, a commitment about which categories within cognitive control are real. As an attempt at that, we run three candidate systems as parallel pathways, one each for regulation, inhibition, and valuation, in an effort to do the linking work between brain and behavior. <EndMark />
